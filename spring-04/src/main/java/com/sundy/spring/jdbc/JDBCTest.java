...
public class JDBCTest {
    ...
    public void testUpdate() {
        ...
        String insertSql = "INSERT INTO employees(last_name, email, dept_id) VALUES(?,?,?)";
        String deleteSql = "delete from  employees WHERE id = ?";

        jdbcTemplate.update(insertSql, "Jack", "admin@qq.com", 5);
        jdbcTemplate.update(deleteSql, 1);
        jdbcTemplate.update(updateSql, "Jack1", 3);
    }
